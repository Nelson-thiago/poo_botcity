...
def main():
    ...
    # Pop-up inicial
    Registro_de_funcionarios = bot.find_app_window(title="Registro de funcionários")
    btn_continuar = bot.find_app_element(from_parent_window=Registro_de_funcionarios, title="&Continuar", class_name="TkChild")
    btn_continuar.click()
