...
def main():
    ...
    produto = Produto('notebook',25000,5)

    bot.find_element('//*[@id="nome"]', By.XPATH).send_keys(produto._nome)
    bot.find_element('//*[@id="preco"]', By.XPATH).send_keys(produto._preco)  # O preço será formatado pelo formulário
    bot.find_element('//*[@id="qnt"]', By.XPATH).send_keys(produto._qnt)
    bot.wait(3000)
